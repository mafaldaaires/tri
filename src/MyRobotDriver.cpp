#include "firstrobot_webots/MyRobotDriver.hpp"
...
void MyRobotDriver::init(
    ...
    std::unordered_map<std::string, std::string> &parameters) {  // Fixed: & added
  node_ = node;
  ...
  cmd_vel_topic_ = parameters.count("cmd_vel_topic") ? parameters["cmd_vel_topic"] : "/cmd_vel";

  cmd_vel_subscription_ = node->create_subscription<geometry_msgs::msg::Twist>(
      cmd_vel_topic_, rclcpp::SensorDataQoS().reliable(),
